...
def main():
    ...
    # calculate_paired_ttests("cifar10_abs_dropout_5em2", "cifar10_baseline")
    # calculate_paired_ttests("cifar10_abs_dropout_1em1", "cifar10_baseline")
    # calculate_paired_ttests("cifar10_abs_dropout_2em1", "cifar10_baseline")
    ...
    # calculate_paired_ttests("cifar10_std_dropout_5em2", "cifar10_baseline")
    # calculate_paired_ttests("cifar10_std_dropout_1em1", "cifar10_baseline")
    # calculate_paired_ttests("cifar10_std_dropout_2em1", "cifar10_baseline")
    # calculate_paired_ttests("cifar10_std_dropout_3em1", "cifar10_baseline")
